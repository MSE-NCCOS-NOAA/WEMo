...
vignette: >
  %\VignetteIndexEntry{Gathering Input Data for WEMo}
...
write.csv(wind_data_summary, file = "wind_data_summary_.csv")
...
ggplot() +
  geom_sf(data = results$wemo_final, aes(color = max_wave_height), size = 3) +
  theme_bw()+
  scale_color_viridis_c()
```

Plot all the effective fetch rays
...
a mess and hard to interpret. you might be better able to examine the rays from a single ray better.
