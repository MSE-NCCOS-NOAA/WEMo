...
```{r summarize-wind, eval = T, fig.alt = "Plot showing a Wind Rose"}
...
```{r download-bathy-data, fig.alt="Map showing bathymetric raster around point of interest"}
...
```{r generate-shorelines, fig.alt="Map showing the shoreline polygon"}
...
```{r plot grid points, fig.alt="map showing the generated grid of points"}
...
```{r plot-all-inputs, fig.alt="Map showing all the inputs together"}
ggplot() +
  geom_spatraster(data = bathy) +
...
```{r fancy-plot, fig.dim=c(9, 6), fig.alt="Fancy plot showing all the inputs together"}
