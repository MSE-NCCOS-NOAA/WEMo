...
- **Data Preparation Tools**: Includes convenience functions to download
  ...
  and bathymetry from NOAA’s \[Continuously Updated Digital Elevation
...
![Map showing input spatial
data](reference/figures/README-examine_input_data-1.png)
...
![Wind rose
plot](reference/figures/README-summarize_and_plot_wind_data-1.png)
...
![Map of WEMo
results](reference/figures/README-plot_final_results-1.png)
...
![Map of WEMo
results](reference/figures/README-plot_final_results-2.png)
...
- **Wind Data**: Download historical wind data from NOAA’s Global
  Historical Climatology Network hourly (GHCNh) using
  [`get_wind_data()`](https://mse-nccos-noaa.github.io/WEMo/reference/get_wind_data.md).
