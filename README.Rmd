...
```{r summarize_and_plot_wind_data}
...
> Walker, Q.A. (2024). *WEMo: An R Implementation of the Wave Exposure Model*. R package version X.X.X. https://github.com/MSE-NCCOS-NOAA/WEMo
